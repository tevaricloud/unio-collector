...
if TYPE_CHECKING:
    from unio_collector.aws.network import PrivateLinkRegionRecord
    from unio_collector.aws.network.topology import NetworkTopologyEvidence


@dataclass(frozen=True)
class PrivateLinkCostReviewEvidence:  # noqa: D101
    records: list[PrivateLinkRegionRecord] = field(default_factory=list)
