...
_EXPORTS = {"RootAccountRecoveryAdvisoryScanner": ("unio_collector.scanners.account_risk.root.recovery.scanner", "RootAccountRecoveryAdvisoryScanner")}

__all__ = ["RootAccountRecoveryAdvisoryScanner"]
