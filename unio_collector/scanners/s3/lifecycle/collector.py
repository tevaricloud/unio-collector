...
class S3LifecycleCostReviewCollector(BaseS3BucketCostScanner):
    """Collect provider evidence for s3-lifecycle-cost-review."""
    ...
    def describe_implementation(self) -> ScannerImplementation:
        ...
        return ScannerImplementation(
            ...
            implementation_class="S3LifecycleCostReviewScanner",
            implementation_module="unio_collector.scanners.s3.lifecycle.scanner",
        )
