...
class RegionalInventoryEvidenceGateway:
    """Delegate EC2 and network inventory collection to the regional source."""

    def __init__(self, source: RegionalInventoryEvidenceSource) -> None:  # noqa: D107
        self._source = source
    ...
    def collect_cached_ec2_records(
        ...
        *,
        ...
        return self._source.collect_cached_ec2_records(
            definition,
    ...
    def collect_cached_ec2_items_by_region(
        ...
        *,
        ...
        return self._source.collect_cached_ec2_items_by_region(
            definition,
            collection_name=collection_name,
            label=label,
    ...
    def get_cached_ec2_regions(
        ...
        return self._source.get_cached_ec2_regions(definition)
    ...
    def create_ec2_collector(
        ...
        *,
        ...
        return self._source.create_ec2_collector(
            definition,
            regions=regions,
        )
    ...
    def collect_cached_network_items_by_region(
        ...
        *,
        ...
        return self._source.collect_cached_network_items_by_region(
            definition,
            collection_name=collection_name,
            label=label,
            collect_items=collect_items,
    ...
    def collect_cached_network_batch(
        ...
        *,
        ...
        """Return cached network inventory grouped by AWS region."""
        return self._source.collect_cached_network_batch(
            definition,
            collection_name=collection_name,
            label=label,
            collect_items=collect_items,
    ...
    def collect_cached_network_nat_gateway_records(
        ...
        return self._source.collect_cached_network_nat_gateway_records(definition)
    ...
    def get_cached_network_regions(
        ...
        return self._source.get_cached_network_regions(definition)
    ...
    def create_network_collector(
        ...
        *,
        ...
        return self._source.create_network_collector(
            definition,
            regions=regions,
        )
